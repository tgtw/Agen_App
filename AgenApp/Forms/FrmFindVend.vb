...
Public Class FrmFindVend
    ...
    Private Sub FrmFindVend_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FrmFindVend_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Query = "SELECT   flkode,flnama,flala1,flala2 FROM [MASVEND] " & _
    ...
    Private Sub Load_Data(sql As String, dtg As DataGridView)
        ...
        Try
            ...
            With dtg
                ...
                .Columns(3).HeaderText = "ADDRESS (2)"
